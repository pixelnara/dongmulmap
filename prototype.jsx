...
const Icon = {
  ...
  Heart: (p) => (
    <svg viewBox="0 0 24 24" fill="none" {...p}>
      <path
        d="M12 20s-7-4.5-7-10a4.5 4.5 0 018-3 4.5 4.5 0 018 3c0 5.5-7 10-7 10z"
        stroke="currentColor"
        strokeWidth="1.8"
  ...
  Phone: (p) => (
    <svg viewBox="0 0 24 24" fill="none" {...p}>
      <path
        d="M5 4h3l2 5-2 1a12 12 0 006 6l1-2 5 2v3a2 2 0 01-2 2A16 16 0 013 6a2 2 0 012-2z"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinejoin="round"
      />
  ...
  TabRecord: (p) => (
    <svg viewBox="0 0 24 24" fill="none" {...p}>
      <rect x="4" y="3" width="14" height="18" rx="2" stroke="currentColor" strokeWidth="1.8" />
...
const HOSPITALS = [
  {
    id: 1,
    name: "OO시타임 OOO 메디컬센터",
    addr: "경기도 하남시 미사강변대로 222 미사 중앙프리미엄 202호",
    dist: 3.2,
    tags: [{ t: "2차OO놀이터", b: true }, { t: "영상OOO과전공의", b: true }, { t: "척사·벡사" }, { t: "공공예송" }],
    phone: "031-558-0000",
    hours: "OO시간 운영",
    x: 0.32,
    y: 0.38,
  },
  {
    id: 2,
    name: "청담 OOO 메디컬센터",
    addr: "서울특별시 강남구 OOO 대로 432 청담빌딩 3층",
    dist: 5.8,
    tags: [{ t: "2차OO놀이터", b: true }, { t: "영상OOO과전공의", b: true }, { t: "척사·벡사" }, { t: "개별입원실" }],
    phone: "02-514-0000",
    hours: "평일 09–22",
    x: 0.58,
    y: 0.28,
  },
  {
    id: 3,
    name: "OO시 HOPE OO놀이터",
    addr: "경기도 성남시 분당구 판교역로 152 알파돔타워 B1",
    dist: 6.4,
    tags: [{ t: "2차OO놀이터", b: true }, { t: "영상OOO과전공의", b: true }, { t: "척사·벡사" }],
    phone: "031-726-0000",
    hours: "OO시간 운영",
    x: 0.48,
    y: 0.58,
  },
  {
    id: 4,
    name: "스마일 OOO 메디컬센터",
    addr: "서울특별시 송파구 올림픽로 300 롯데월드타워 지하 2층",
    dist: 7.2,
    tags: [{ t: "2차OO놀이터", b: true }, { t: "영상OOO과전공의", b: true }, { t: "척사·벡사" }, { t: "개별입원실" }],
    phone: "02-414-0000",
    hours: "평일 09–20",
  ...
  },
  {
    id: 5,
    name: "라온 OOO의료원",
    addr: "서울특별시 서초구 강남대로 401 미래에셋센터빌딩 4층",
    dist: 8.1,
    tags: [{ t: "2차OO놀이터", b: true }, { t: "영상OOO과전공의", b: true }, { t: "고양이친화병원" }],
    phone: "02-588-0000",
    hours: "평일 10–21",
    x: 0.62,
    y: 0.65,
  ...
  <div className="status-bar">
    ...
    <div className="status-right">
      <svg viewBox="0 0 17 11" fill="currentColor">
        <rect y="7" width="3" height="4" rx=".5" />
        <rect x="4" y="5" width="3" height="6" rx=".5" />
        <rect x="8" y="3" width="3" height="8" rx=".5" />
        <rect x="12" y="0" width="3" height="11" rx=".5" />
      </svg>
      <svg viewBox="0 0 16 11" fill="none">
        <path
          d="M8 2c-2.5 0-4.8.9-6.5 2.5l.8.8A7.5 7.5 0 018 3.5c2.1 0 4 .8 5.7 2.3l.8-.8A8.5 8.5 0 008 2zm0 2.5a6 6 0 00-4.2 1.7l.8.8A4.7 4.7 0 018 5.7c1.3 0 2.5.5 3.4 1.3l.8-.8A6 6 0 008 4.5zm0 2.5a3.4 3.4 0 00-2.4 1l2.4 2.4 2.4-2.4A3.4 3.4 0 008 7z"
          fill="currentColor"
        />
      </svg>
      <svg viewBox="0 0 25 12" fill="none">
        <rect x=".5" y=".5" width="21" height="11" rx="2.5" stroke="currentColor" opacity=".5" />
        <rect x="2" y="2" width="18" height="8" rx="1.2" fill="currentColor" />
        <rect x="22" y="3.5" width="1.5" height="5" rx=".5" fill="currentColor" opacity=".5" />
      </svg>
    </div>
  </div>
);
...
const HospitalCard = ({ h, onClick }) => (
  <button
    className="hcard"
    onClick={onClick}
    style={{ textAlign: "left", width: "100%", border: "none", borderBottom: "1px solid var(--c-line)" }}
  >
    ...
    <div className="hbody">
      ...
      <div className="htags">
        {h.tags.map((tag, i) => (
          <span key={i} className={"tag-chip" + (tag.b ? " brand" : "")}>
            {tag.t}
          </span>
        ))}
      </div>
...
const ListScreen = ({ go, tab, setTab, openRegion, region }) => {
  const title = region ? `${region.prov} · ${region.dist}` : "영상OOO과 전문 OO놀이터";
  const desc = region ? "선택한 지역에서 조건에 맞는 병원이에요" : "엑스레이, 초음파를 보다 더 자세히 보고 싶다면";
  return (
    <div className="screen">
      <StatusBar />
      <div className="nav-bar">
        <button className="back" onClick={() => {}} aria-label="back">
          <Icon.ChevronLeft style={{ width: 24, height: 24 }} />
        </button>
      ...
      <div className="content">
        ...
        {HOSPITALS.map((h) => (
          <HospitalCard key={h.id} h={h} onClick={() => go("detail", h)} />
        ))}
...
const RegionSheet = ({ open, close, onConfirm, initial }) => {
  ...
  useEffect(() => {
    if (open) {
      setProv(initial?.prov || "서울시");
      setDist(initial?.dist || "전체");
    }
  }, [open]);
  return (
    <>
      ...
      <div className={"sheet" + (open ? " open" : "")} style={{ height: "70%", pointerEvents: open ? "auto" : "none" }}>
        ...
        <div className="sheet-cta">
          <button className="btn-primary" onClick={() => onConfirm({ prov, dist })}>
            병원찾기
          </button>
        </div>
      </div>
...
const MapScreen = ({ go, tab, setTab }) => {
  ...
  return (
    <div className="screen">
      <StatusBar />
      <div className="nav-bar">
        <button className="back" onClick={() => go("list")} aria-label="back">
          <Icon.ChevronLeft style={{ width: 24, height: 24 }} />
        </button>
      ...
      <div className="map-wrap">
        <div className="map-chips">
          {FILTER_CHIPS.map((c) => (
            <button
              key={c.id}
              className={"map-chip" + (activeChip === c.id ? " active" : "")}
        ...
        <button className="my-location" aria-label="내 위치">
          <Icon.Locate style={{ width: 22, height: 22 }} />
        </button>
        <MapSVG />
        {/* Pins */}
        {HOSPITALS.map((h) => {
          ...
          return (
            ...
            >
              <svg viewBox="0 0 28 36" style={{ width: "100%", height: "100%" }}>
                <path d="M14 0C6.3 0 0 6.3 0 14c0 10 14 22 14 22s14-12 14-22C28 6.3 21.7 0 14 0z" fill="currentColor" />
  ...
  <div className="screen">
    <div className="detail-hero">
      <div className="detail-header-float">
        <button className="icon-btn" onClick={() => go("list")}>
          <Icon.ChevronLeft style={{ width: 20, height: 20 }} />
        </button>
    ...
    <div className="content">
      <div className="detail-body">
        <h1>{h.name}</h1>
        <div className="dist">
          <Icon.Pin style={{ width: 14, height: 14 }} /> {h.dist.toFixed(1)} km · {h.addr}
        </div>
        <div className="specs">
          {h.tags.map((tag, i) => (
            <span key={i} className={"tag-chip" + (tag.b ? " brand" : "")}>
        ...
        <div className="detail-section">
          ...
          <div className="info-row">
            ...
            <span className="val">{h.hours}</span>
          </div>
          <div className="info-row">
            <span className="label">전화</span>
            <span className="val">{h.phone}</span>
          </div>
          <div className="info-row">
            <span className="label">주차</span>
            <span className="val">건물 내 주차 가능 (2시간 무료)</span>
          </div>
        </div>
        <div className="detail-section">
          <h3>영상OOO과 장비</h3>
          <div className="info-row">
            ...
            <span className="val">GE Revolution ACT 16ch</span>
          </div>
          <div className="info-row">
            <span className="label">MRI</span>
            <span className="val">Siemens Magnetom Essenza 1.5T</span>
          </div>
          <div className="info-row">
            <span className="label">초음파</span>
            <span className="val">Samsung RS85 Prestige</span>
          </div>
        </div>
        <div className="detail-section">
          <h3>최근 리뷰</h3>
    ...
    <div className="cta-bar">
      <button className="btn-secondary" aria-label="전화">
        <Icon.Phone style={{ width: 20, height: 20 }} />
      </button>
      <button className="btn-secondary" aria-label="지도">
    ...
    <div className="tweaks-panel open">
      ...
      <div className="tweak-row">
        ...
        <input
          ...
          max="40"
          step="1"
          value={tweaks.thumbRadius}
          onChange={(e) => setSize("thumbRadius", +e.target.value)}
        />
      </div>
      <div className="tweak-row">
...
function App() {
  const [screen, setScreen] = useState(() => {
    try {
      return localStorage.getItem("hc360_screen") || "list";
    } catch (e) {
      return "list";
    }
  });
  ...
  useEffect(() => {
    try {
      localStorage.setItem("hc360_screen", screen);
    } catch (e) {}
  }, [screen]);
